...
class TestMaxErr(BaseTestMetricBase, unittest.TestCase):
    ...
    def test_transform_with_filter(self):
        ...
        mae = MaxErr(filter_method=filter_mock)
    ...
    def test_transform_without_predictions(self):
        ...
        self.assertEqual(e_info.value.message,
                         "No predictions are provided as input for the MaxErr.  You should add the predictions by a "
                         "seperate key word arguments if you add the MaxErr to the pipeline.")