...
class TestMinErr(BaseTestMetricBase, unittest.TestCase):
    ...
    def test_transform_with_filter(self):
        ...
        mae = MinErr(filter_method=filter_mock)
    ...
    def test_transform(self):
        ...
        expected_result = {"gt": 0.0, "pred1": 0, "pred2": 1}
    ...
    def test_transform_cutouts(self):
        ...
        test_result = self.metric.transform(file_manager=MagicMock(), y=test_data['testCol'],
                                          pred1=test_data['predictCol1'])
        expected_result = {"pred1": 0,
                           "pred1: Cut from 2015-06-03 01:00:00 to 2015-06-03 03:00:00" : 0}
    ...
    def test_transform_without_predictions(self):
        ...
        self.assertEqual(e_info.value.message,
                         "No predictions are provided as input for the MinErr.  You should add the predictions by a "
                         "seperate key word arguments if you add the MinErr to the pipeline.")
